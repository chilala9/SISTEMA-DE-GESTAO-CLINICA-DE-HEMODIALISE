...
echo "$logados"; ?></p>
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Cadastrar Equipamentos</h5>
              <div class="card">
                <div class="card-body">
                  <form action="../../config/cadastrarEquipamento.php" method="POST">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Descrição de equipamento</label>
                      
                      <textarea name="descricao" id="" cols="5" rows="3" name="endereco" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
