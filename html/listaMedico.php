                    ...
                    <table class="table text-nowrap mb-0 align-middle">
                      <thead class="text-dark fs-4">
                        <tr>
                          ...
                          <th class="border-bottom-0">
                            <h6 class="fw-semibold mb-0">Análises(Imunologia-Bioquimica-Hematologia)</h6>
                          </th>
                          <th class="border-bottom-0">
    ...
    if ($sessao1->num_rows > 0) {
        while ($listL = $sessao1->fetch_assoc()) {
            ...
            if ($listL['estadoP'] == 1) {
                ...
                echo "<td class='border-bottom-0'>";
                echo " <div class='d-flex align-items-center gap-2'>";
                echo "<a class='badge bg-warning rounded-3 fw-semibold' href='cadastrarMedico.php?id_paciente={$listL['id_paciente']}' >Prescrever</a>";
                echo '</div>';
                echo '</td>';
            } elseif ($listL['estadoP'] > 1) {
                echo '<h4>Sem registro para prescrever</h4>';
            }
            echo '</tr>';
        }
    } else {
