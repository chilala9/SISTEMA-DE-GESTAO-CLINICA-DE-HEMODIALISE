<?php
include '../../config/listarEquipamento.php';
                    ...
                    <table class="table text-nowrap mb-0 align-middle">
                      ...
                      <?php
                          ...
                          if($resultado2->num_rows > 0){
                            ...
                            while ($listL = $resultado2->fetch_assoc()) {
                            


                        echo"<tr>";
                          echo"<td class='border-bottom-0'><h6 class='fw-semibold mb-0'>{$listL['id_equipamento']}</h6></td>";
                           
                            echo"<td class='border-bottom-0'>";
                          echo"<div class='d-flex align-items-center gap-2'>";
                            echo"<span class='badge bg-success rounded-3 fw-semibold'>{$listL['nome_equipamento']}</span>";
                          echo"</div>";
                        echo"</td>";
                          ...
                          echo"<td class='border-bottom-0'>";
                         echo" <div class='d-flex align-items-center gap-2'>";
                            echo"<span class='badge bg-primary rounded-3 fw-semibold'>{$listL['descricao']}</span>";
                          echo"</div>";
                        echo"</td>";
